...
vim.keymap.set("n", "<leader><leader>k", "<cmd>bprev<CR>", { desc = 'Previous buffer' })
...
vim.keymap.set( "n", "<leader><leader>q", "<cmd>bdelete!<CR>", { desc = "delete buffer (force, without saving)" })
